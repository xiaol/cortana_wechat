...
// 获取答案
function get_answer(question,chat_item){
...
// 获取音乐链接
function get_music(query){
	var path = mydata.getMusic,rqd = {};
	rqd.format = "json";
	rqd.calback = '';
	rqd.from = 'webapp_music';
	rqd.method = 'baidu.ting.search.catalogSug&query='+query;
	base.dataConn(path,rqd,'get',function(data){
		console.log(data);
	});
}
